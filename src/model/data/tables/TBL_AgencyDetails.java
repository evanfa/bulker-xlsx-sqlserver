...
public class TBL_AgencyDetails {
    ...
    public TBL_AgencyDetails(int idAgency, String agencyDetails, String agencyAddress, int idState, int idCity, String agencyPhone, String officeDays, String officeHoursM, String idMatrix) {
