...
public class TBL_Permits {
    ...
    public TBL_Permits(String idMatrix, String idPermit, String permitName, String permitDes, int agencyPermit, int classPermit, String deptoPermit) {
